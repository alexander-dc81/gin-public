...
func init() {
	...
	revel.TemplateFuncs["plugin_html"] = func(a interface{}) template.HTML {
		htmlGenerated := ""
		...
		path = path + "/app/views/plugins/html/" + fmt.Sprint(a) + "/"
	...
	revel.TemplateFuncs["load_relation"] = func(a interface{}) []models.RelationInstance {
		return controllers.EntityInstanceRelation(a.(uint))
	}
}
